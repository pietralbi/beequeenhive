...
local function ShakeIfClose(inst)
    ...
    if player then
        player.components.playercontroller:ShakeCamera(inst, "FULL", .5, .02, .15, SHAKE_DIST)
    end
end
...
local function DoScreechAlert(inst)
    inst:Scare(5, TUNING.BEEQUEEN_EPICSCARE_RANGE)
...
local states =
{
    ...
    State{
        ...
        timeline =
        {
            ...
            U.OnNoSleepTimeEvent(54 * FRAMES, function(inst)
    ...
    State{
        ...
        timeline =
        {
            ...
            U.OnNoSleepTimeEvent(57 * FRAMES, function(inst)
                inst.sg:RemoveStateTag("busy")
                inst.sg:RemoveStateTag("nosleep")
                inst.sg:RemoveStateTag("nofreeze")
            end),
    ...
    State{
        ...
        timeline =
        {
            ...
            U.OnNoSleepTimeEvent(32 * FRAMES, function(inst)
                inst.sg:RemoveStateTag("busy")
                inst.sg:RemoveStateTag("nosleep")
                inst.sg:RemoveStateTag("nofreeze")
            end),
    ...
    State{
        ...
        events =
        {
            U.OnNoSleepAnimOver("focustarget_loop"),
        },
    ...
    State{
        ...
        timeline =
        {
            ...
            U.OnNoSleepTimeEvent(35 * FRAMES, function(inst)
                inst.sg:AddStateTag("caninterrupt")
                inst.sg:RemoveStateTag("nosleep")
                inst.sg:RemoveStateTag("nofreeze")
            end),
...
U.AddSleepExStates(states,
{
    ...
    waketimeline =
    {
        ...
        U.OnNoSleepTimeEvent(24 * FRAMES, function(inst)
            inst.sg:RemoveStateTag("busy")
            inst.sg:RemoveStateTag("nosleep")
        end),
    },
...
U.AddFrozenStates(states, OnOverrideFrozenSymbols, OnClearFrozenSymbols)
